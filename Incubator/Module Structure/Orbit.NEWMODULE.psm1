# using module .\Class\Orbit.NEWMODULE.Classes.psm1
# Above needs to remain the first line to import Classes
# remove the comment when using classes

#requires -Version 5
#Requires -Modules @{ ModuleName="Microsoft.Graph.NEWMODULE"; ModuleVersion="1.9.6" }
Import-Module Microsoft.Graph.NEWMODULE
